...
class NoteCard extends ConsumerWidget {
  ...
  Color _getCardColor(int index) {
    final colors = [
      const Color(0xFFFE90E8), // pink
      const Color(0xFF99E885), // kuning
      const Color(0xFFC0F7FE), // hijau mint
      const Color(0xFFFFDCC8B), // biru
    ];
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      child: InkWell(
        onTap: () => context.go('/add-note/${note.id}'),
        child: Stack(
